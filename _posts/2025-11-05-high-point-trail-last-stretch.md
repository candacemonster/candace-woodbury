...
{% include figure.html
  src="/assets/images/posts/high-point-trail/desert-marigold.jpg"
  alt="yellow desert marigold" %}

{% include figure.html
  src="/assets/images/posts/high-point-trail/desert-grass.jpg"
  alt="long grasses catching wind on the trail" %}

{% include figure.html
  src="/assets/images/posts/high-point-trail/purple-asters.jpg"
  alt="purple asters among desert rosette leaves" %}

{% include figure.html
  src="/assets/images/posts/high-point-trail/orange-globemallow.jpg"
  alt="orange globemallow" %}

{% include figure.html
  src="/assets/images/posts/high-point-trail/globemallow-cluster.jpg"
  alt="globemallow cluster" %}
...
{% include figure.html
  src="/assets/images/posts/high-point-trail/tove.jpg"
  alt="tove — trail partner, explorer, and heart" %}

no one tells you which ordinary morning becomes the one you replay. no one warns you how sharp it turns once you know.

[^1]: [high point trail on onx backcountry](https://webmap.onxmaps.com/backcountry/share/content?share_id=01K9BB0T9W97DABF1ZH4QM8XMQ) — a line on the map for plans you don't realize you're about to lose.