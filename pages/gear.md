  ...
  <section class="gear-category">
    ...
    <div class="gear-group">
      ...
      <ul class="gear-list">
        ...
        <li class="gear-item">
          <span class="gear-name">scale</span>
          <span class="gear-note">survived multiple moves. still accurate.</span>
          <span class="gear-rating">★★★★☆</span>
        </li>
        <li class="gear-item">
  ...
  <section class="gear-category">
    ...
    <div class="gear-group">
      ...
      <ul class="gear-list">
        ...
        <li class="gear-item">
          ...
          <span class="gear-note">spy happy lenses. protect the eyes always.</span>
          <span class="gear-rating">★★★★☆</span>
        </li>
      </ul>
    </div>
    <div class="gear-group">
      ...
      <ul class="gear-list">
        <li class="gear-item">
          <span class="gear-name">
            <a href="https://chums.com/collections/wallets/products/surfshorts-wallet?variant=42946164523205" target="_blank" rel="noopener">
              chums wallet
            </a>
          </span>
        ...
        <li class="gear-item">
          <span class="gear-name">nasa pen</span>
          <span class="gear-note">in the chums. writes anywhere, anytime.</span>
          <span class="gear-rating">★★★★★</span>
        </li>
        <li class="gear-item">
  ...
  <section class="gear-category">
    ...
    <div class="gear-group">
      ...
      <ul class="gear-list">
        ...
        <li class="gear-item">
          <span class="gear-name">
            <a href="https://amzn.to/4mI3HYu" target="_blank" rel="noopener">
              cycplus inflator
            </a>
          </span>
          <span class="gear-note">tires, sports balls, optimism included.</span>
          <span class="gear-rating">★★★★☆</span>
        </li>
      </ul>
    </div>
    <div class="gear-group">
      ...
      <ul class="gear-list">
        ...
        <li class="gear-item">
          <span class="gear-name">other handy</span>
          <span class="gear-note">first aid, snacks, tick kit, the usual.</span>
          <span class="gear-rating">★★☆☆☆</span>
        </li>
      </ul>
    </div>
    <div class="gear-group">
      ...
      <ul class="gear-list">
        ...
        <li class="gear-item">
          <span class="gear-name">other handy</span>
          <span class="gear-note">leash, sunscreen, hat. the usual suspects.</span>
          <span class="gear-rating">★★☆☆☆</span>
        </li>
      </ul>
    </div>
  ...
  <section class="gear-category">
    ...
    <div class="gear-group">
      ...
      <ul class="gear-list">
        ...
        <li class="gear-item">
          <span class="gear-name">
            <a href="https://www.amazon.com/hz/wishlist/ls/DHOXLOZ0FH00?ref_=wl_share" target="_blank" rel="noopener">
              full wishlist
            </a>
          </span>
